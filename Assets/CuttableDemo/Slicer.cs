...
namespace Assets.Scripts
{
    class Slicer
    {
        ...
        {            
            ...
            var physicMaterial = objectToCut.GetComponent<Collider>().material;
            
            
            SetupCollidersAndRigidBodies(ref positiveObject, positiveSideMeshData, sliceable.UseGravity, physicMaterial);
            SetupCollidersAndRigidBodies(ref negativeObject, negativeSideMeshData, sliceable.UseGravity, physicMaterial);
        ...
        private static void SetupCollidersAndRigidBodies(ref GameObject gameObject, Mesh mesh, bool useGravity, PhysicMaterial physicMaterial)
        {                     
            ...
            rb.AddForce(rb.transform.forward * 1, ForceMode.Impulse);
        }
    }
}
